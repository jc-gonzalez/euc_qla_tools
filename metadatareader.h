...
public:
    ...
    virtual bool getMetadataInfoStr(std::string & md) { return false; }
    virtual bool getMetadataInfo(json::Object & md) { return false; }
...
public:
    ...
    virtual bool getMetadataInfo(json::Object & md) {
        std::string content;
        bool retVal = readFitsMetadata(content);
        if (retVal) {
	    json::Parser parser;
	    retVal |= parser.parse(content, md);
	}
        return retVal;
    }
